...
public class CameraFragment extends Fragment {
     ...
     *
     *
     * 给定相机支持的{@code Size}的{@code choices}，选择其中最小的一个
     * 的大小至少与相应的纹理视图大小相同，而该视图的大小最多与
     * 各自的最大尺寸，其长宽比与指定值匹配。如果这样的大小
     * 不存在，请选择最大的一个，它最多与相应的最大大小相同，
     * 以及其纵横比与指定值匹配的。
     * *
     * *@param选择相机为预期输出支持的大小列表
     * 类
     * 纹理视图相对于传感器坐标的宽度
     * *@param textureViewHeight纹理视图相对于传感器坐标的高度
     * *@param maxWidth可以选择的最大宽度
     * * @param maxHeight可以选择的最大高度
     * * @param aspectRatio长宽比
     * * @返回最优的{@code Size}，如果没有足够大，则返回任意值
     */
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
     ...
     * 此方法应在相机预览大小确定后调用
     *  setupcameraoutput和mTextureView的大小是固定的。
     *
